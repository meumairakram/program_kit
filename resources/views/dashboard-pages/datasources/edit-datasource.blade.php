                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="@error('user.phone')border border-danger rounded-3 @enderror">
                                        <select class="form-control" name="type" value="{{$datasource->type}}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.location') border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="file" placeholder="Location" id="name" name="csv_file" value="{{$datasource->file_path}}">
                                </div>
                            </div>
                        </div>
                    </div>
