...
@section('content')
    ...
    <form class="container-fluid py-4" action="{{ route('update-datasource') }}" method="POST" enctype="multipart/form-data" role="form text-left">
            <div class="card mb-4">
                <div class="card-header pb-0 px-3">
                    <div class="d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">Edit Datasource</h5>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="@error('user.name')border border-danger rounded-3 @enderror">
                                        <input class="form-control" type="text" placeholder="Title" id="campaign-title" name="name" value="{{$datasource->name}}">
                                            @error('name')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="@error('user.phone')border border-danger rounded-3 @enderror">
                                        <select class="form-control" name="type" id="selectType" value="{{$datasource->type}}">
                                            <option value="csv">{{$datasource->type}}</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="d-flex justify-content-start">
                                <button type="submit" class="btn bg-gradient-dark btn-md mt-4 mb-4">Update Data source</button>
                            </div>
                        </div>
...
@if(isset($absolute_file_path))
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            var headers = @json($csvHeaders);
            var rows = @json($first_10_records);
            console.log(headers);
            console.log(rows);
