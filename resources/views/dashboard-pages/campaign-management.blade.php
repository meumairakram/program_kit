...
<div>
    ...
    <div class="row" x-data="$store.manage_campaign">
        <div class="col-12">
                                ...
                                @foreach($campaigns as $camp)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="{{ url('delete-campaign')}}/{{$camp->id}}" class="mx-2" data-bs-toggle="tooltip" data-bs-original-title="Delete Campaign">
...
@section('javascript')
    ...
    <script id="create_campaign_script" src="{{ asset('js/campaign_management.js') }}" ></script>
